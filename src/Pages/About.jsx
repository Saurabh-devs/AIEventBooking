...
const About = () => {
  return (
    <div className="min-h-screen bg-gradient-to-r from-[#f0f9ff] to-[#e0f2fe] px-6 py-12">
      
      {/* Hero Section */}
      <section className="mb-16 text-center">
        <h1 className="text-4xl md:text-5xl font-bold mb-4 bg-gradient-to-r from-teal-500 to-aqua-400 bg-clip-text text-transparent drop-shadow-md tracking-tight">
          EventMate – Plan Smarter, Celebrate Better
        </h1>
      ...
      {/* About Section */}
      <section className="mb-16 bg-white rounded-xl p-8 md:p-12 text-center shadow-lg border border-teal-200">
        <h2 className="text-3xl md:text-4xl font-bold text-gray-800 inline-block pb-2 mb-6 border-b-4 border-teal-500">
          About EventMate
        </h2>
      ...
      {/* Features Section */}
      <section className="mb-16 bg-white rounded-xl p-8 md:p-12 shadow-lg border border-teal-200">
        <h2 className="text-3xl md:text-4xl font-bold text-gray-800 text-center inline-block pb-2 mb-10 border-b-4 border-teal-500">
          Features
        </h2>
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          
          {/* Feature Box 1 */}
          <div className="bg-gradient-to-br from-teal-50 to-aqua-50 rounded-xl p-6 hover:shadow-md hover:scale-105 transition transform duration-300 border border-teal-100">
          ...
          {/* Feature Box 2 */}
          <div className="bg-gradient-to-br from-teal-50 to-aqua-50 rounded-xl p-6 hover:shadow-md hover:scale-105 transition transform duration-300 border border-teal-100">
            <div className="text-teal-500 text-3xl mb-3">🏛️</div>
            <h3 className="text-xl font-semibold text-teal-700">
              Venue Management
            </h3>
            <p className="mt-3 text-gray-700">
          ...
          <div className="bg-gradient-to-br from-teal-50 to-aqua-50 rounded-xl p-6 hover:shadow-md hover:scale-105 transition transform duration-300 border border-teal-100">
            ...
            <p className="mt-3 text-gray-700">
              Receive AI-powered suggestions for themes, vendors, and event ideas.
            </p>
          </div>
          ...
          <div className="bg-gradient-to-br from-teal-50 to-aqua-50 rounded-xl p-6 hover:shadow-md hover:scale-105 transition transform duration-300 border border-teal-100">
            ...
            <p className="mt-3 text-gray-700">
              Organize, assign, and track all event tasks in one platform.
            </p>
          </div>
          ...
          <div className="bg-gradient-to-br from-teal-50 to-aqua-50 rounded-xl p-6 hover:shadow-md hover:scale-105 transition transform duration-300 border border-teal-100">
            ...
            <p className="mt-3 text-gray-700">
              Gain actionable insights on attendee engagement and performance.
            </p>
          </div>
      ...
      <section className="mb-16 bg-white rounded-xl p-8 md:p-12 shadow-lg border border-teal-200">
        ...
        <div className="mb-10 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-800 inline-block pb-2 border-b-4 border-teal-500">
            Our Mission
          </h2>
          <p className="mt-6 text-lg md:text-xl text-gray-700 leading-relaxed max-w-4xl mx-auto">
            At EventMate, our mission is to empower people to focus on what truly
        ...
        {/* Call to Action */}
        <div className="mb-10 text-center bg-gradient-to-r from-teal-50 to-aqua-50 p-8 rounded-xl">
          ...
          <button className="px-8 py-3 bg-gradient-to-r from-teal-500 to-aqua-400 text-white font-semibold rounded-full shadow-md hover:scale-105 transition-transform duration-300">
            Get Started
          </button>
        </div>
      ...
      <footer className="py-6 text-center">
        <p className="text-gray-700">
          © 2025 <span className="text-teal-600 font-semibold">EventMate</span>. 
          All rights reserved.
        </p>
      </footer>
    </div>
